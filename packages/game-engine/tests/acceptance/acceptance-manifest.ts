...
export const acceptanceScenarios: readonly AcceptanceScenario[] = [
  ...
  scenario("DOM-006", "domain", ["AC-03"], ["OFF-ROUND-COUNT", "OFF-R1-PROFESSION", "OFF-R2-R5-CHOICE", "APR-R1-PROFESSION-OPTIONAL"], "five base rounds reveal profession first unless the host opened round one, then one legal chosen ordinary card later", ["exactlyFiveBaseRounds", "professionForcedFirst", "professionOptionalWhenHostAllows", "oneOrdinaryRevealLater", "illegalCategoryRejected"], { ...fakeClock }),
  ...
  scenario("DOM-021", "domain", ["AC-17"], REQUIRED_RULE_IDS, "traceability inventory contains every official rule family and exactly the approved product overrides", ["allRequiredRuleIdsCovered", "approvedRuleIdsMatchInventory", "noUnclassifiedDeviation"]),
